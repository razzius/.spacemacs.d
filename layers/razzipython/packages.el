...
(defun razzipython/init-anaconda-mode ()
...
(defun razzipython/post-init-company ()
  ;; backend specific
...
(defun razzipython/init-company-anaconda ()
  (use-package company-anaconda
    :defer t
    ;; see `spacemacs//python-setup-anaconda-company'
    ))

(defun razzipython/init-cython-mode ()
...
(defun razzipython/init-lsp-python ()
  (use-package lsp-python
    :commands lsp-python-enable
    :init (add-hook 'python-mode-hook 'lsp-mode)))

(defun razzipython/init-nose ()
  (use-package nose
...
(defun razzipython/init-pip-requirements ()
  (use-package pip-requirements
    :defer t))

(defun razzipython/init-pippel ()
  (use-package pippel
    :defer t
...
(defun razzipython/init-py-isort ()
...
(defun razzipython/pre-init-pyenv-mode ()
  (add-to-list 'spacemacs--python-pyenv-modes 'python-mode))
(defun razzipython/init-pyenv-mode ()
...
(defun razzipython/pre-init-pyvenv ()
  (add-to-list 'spacemacs--python-pyvenv-modes 'python-mode))
(defun razzipython/init-pyvenv ()
  (use-package pyvenv
    :defer t
    :init
    (progn
...
(defun razzipython/init-pylookup ()
...
(defun razzipython/post-init-semantic ()
...
(defun razzipython/pre-init-smartparens ()
...
(defun razzipython/post-init-smartparens ()
  (add-hook 'inferior-python-mode-hook 'smartparens-mode))

(defun razzipython/post-init-stickyfunc-enhance ()
  (add-hook 'python-mode-hook 'spacemacs/load-stickyfunc-enhance))

(defun razzipython/pre-init-xcscope ()
  (spacemacs|use-package-add-hook xcscope
    :post-init
    (spacemacs/set-leader-keys-for-major-mode 'python-mode
      "gi" 'cscope/run-pycscope)))

(defun razzipython/init-yapfify ()
  (use-package yapfify
    :defer t
    :init
    (progn
