...
(defun razzishell/pre-init-company ()
  ;; support in eshell
...
(defun razzishell/init-eshell ()
  (use-package eshell
    ...
    (progn
      ...
      (when razzishell-protect-eshell-prompt
...
(defun razzishell/init-esh-help ()
  (use-package esh-help
    :defer t
    :init (add-hook 'eshell-mode-hook 'eldoc-mode)
    :config (setup-esh-help-eldoc)))

(defun razzishell/init-eshell-prompt-extras ()
  ...
  (use-package shell-pop
    ...
    (progn
      ...
      (defun spacemacs/default-pop-shell ()
        ...
        (interactive)
        (let ((shell (if (eq 'multi-term razzishell-default-shell)
                         'multiterm
                       razzishell-default-shell)))
...
(defun razzishell/pre-init-magit ()
